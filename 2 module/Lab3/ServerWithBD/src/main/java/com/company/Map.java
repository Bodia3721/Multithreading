...
//            System.out.println(" >> " + e.getMessage());
    ...
    public String showCountries() {
        String sql = "SELECT ID_CO, NAME FROM COUNTRIES";
        String res = "[Map::showCountries()] ÑÏÈÑÎÊ ÑÒĞÀÍ:" + "#";
        try
        {
            ResultSet rs = statement.executeQuery(sql);
        ...
        {
            res = "[Map::showCountries()] ÎØÈÁÊÀ ïğè ïîëó÷åíèè ñïèñêà ñòğàí";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public String showCities(int idCountry){
        ...
        {
            ResultSet rs = statement.executeQuery(sql);
            res = "[Map::showCities()] ÑÏÈÑÎÊ ÃÎĞÎÄÎÂ: " + "#";
        ...
        {
            res = "[Map::showCities()] ÎØÈÁÊÀ ïğè ïîëó÷åíèè ñïèñêà ãîğîäîâ";
    ...
    public String showAllCities(){
        ...
        {
            ResultSet rs = statement.executeQuery(sql);
            res += "[Map::showAllCities()] ÑÏÈÑÎÊ ÂÑÅÕ ÃÎĞÎÄÎÂ: " + "#";
